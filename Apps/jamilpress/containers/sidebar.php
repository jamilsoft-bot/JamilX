            ...
            <a href="jamilpress">
            <img src="Apps/jamilpress/assets/images/jamilpress banner.png" style="width: 200px;">
            </a>
            </div>
            <div class="w3-container justify-content-center d-flex p-3">
                <div class="w3-dropdown-click p-2 w3-round-xxlarge" style="width: 150pt;">
                    <button onclick="w3.toggleShow('#newbtn')" class="w3-button w3-round-xxlarge w3-block w3-card">Create</button>
                    <div id="newbtn" class="w3-dropdown-content w3-bar-block w3-border" style="width: 100%;">
                      <a href="?action=createblog" class="w3-bar-item w3-button">Blog</a>
                      <a href="?action=createpost" class="w3-bar-item w3-button">Post</a>
                      <a href="?action=createpage" class="w3-bar-item w3-button">Page</a>
                      <a href="?action=createcat" class="w3-bar-item w3-button">Category</a>                      
                    </div>
                </div>
            </div>
            <div class="w3-container w3-margin-top">
                <div class="w3-bar-block w3-card">
                  <a href="#" class="w3-bar-item w3-blue w3-button">Manage</a>
