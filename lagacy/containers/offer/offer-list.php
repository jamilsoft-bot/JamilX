<section class="bg-slate-50 py-10">
    <div class="mx-auto max-w-6xl px-6">
        <header class="rounded-3xl bg-gradient-to-r from-fuchsia-600 via-purple-500 to-indigo-500 p-8 text-white shadow-lg">
            ...
            <p class="mt-2 text-sm text-purple-100">Review and refine active marketing offers.</p>
        </header>
                        ...
                        <?php
                            ...
                            global $db, $JX_db;
                                ...
                                foreach($row as $r){
                                    ...
                                    echo "<td class='px-4 py-3 text-slate-600'>$link</td>";
                                    ...
                                    echo "<td class='px-4 py-3'>
                                        <div class='flex items-center gap-2'>
                                            ...
                                            <a href='dashboard?b=$code&action=offerupdate&oid=$id' class='inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-semibold text-slate-600'><i class='fa fa-edit'></i></a>
                                            <a href='dashboard?b=$code&action=offers&del=$id' class='inline-flex items-center justify-center rounded-full border border-rose-200 bg-rose-50 px-3 py-1 text-xs font-semibold text-rose-600'><i class='fa fa-trash'></i></a>
                                        </div>
                                    </td>";
                                }
