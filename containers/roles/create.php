<div class="w3-container m-3">
    <form action="" method="post" class="row">
        <div class="col-md-6">
            <label class="w3-text-blue">Role Name</label>
            <input type="text" name="name" class="w3-border-blue w3-leftbar w3-border w3-input">
        </div>
        <div class="col-md-6">
            <label class="w3-text-blue">Role Description</label>
            <input type="text" name="summary" class="w3-border w3-leftbar w3-border-blue w3-input">
        </div>
        <div class="col-md-6">
            <label class="w3-text-blue">Role Category</label>
            <select name="category" class="w3-input w3-border w3-border-blue w3-leftbar">
                <?php
                    global $JX_db;
