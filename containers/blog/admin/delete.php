...
<div class="rounded-xl border border-rose-200 bg-white p-6">
    ...
    <form action="/admin/blog/delete/<?php echo blog_html($post['id']); ?>" method="post" class="mt-6 flex gap-3">
        <a href="/admin/blog" class="rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-slate-50">Cancel</a>
