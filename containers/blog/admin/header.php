...
<header class="border-b border-slate-200 bg-white">
    <div class="max-w-6xl mx-auto px-4 py-5 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div class="flex gap-2">
            ...
            <a href="admin/blog?action=new" class="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-700">New Post</a>
        </div>
    </div>
    <nav class="border-t border-slate-200 bg-slate-50">
        <div class="max-w-6xl mx-auto px-4 py-3 flex flex-wrap gap-4 text-sm font-medium">
            <a href="admin/blog?action=index" class="text-slate-600 hover:text-slate-900">Dashboard</a>
            <a href="admin/blog?action=categories" class="text-slate-600 hover:text-slate-900">Categories</a>
            <a href="admin/blog?action=tags" class="text-slate-600 hover:text-slate-900">Tags</a>
        </div>
    </nav>
</header>
