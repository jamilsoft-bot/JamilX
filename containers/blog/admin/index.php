...
<section class="mt-8 rounded-xl border border-slate-200 bg-white">
    <div class="flex items-center justify-between border-b border-slate-200 px-6 py-4">
        ...
        <a href="blog?action=admin-new" class="text-sm font-semibold text-indigo-600 hover:text-indigo-700">Create post</a>
    </div>
                        ...
                        <tr class="border-t border-slate-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-2">
                                    <a href="blog?action=admin-edit&id=<?php echo blog_html($post['id']); ?>" class="text-indigo-600 hover:text-indigo-700">Edit</a>
                                    <a href="blog?action=admin-delete&id=<?php echo blog_html($post['id']); ?>" class="text-rose-600 hover:text-rose-700">Delete</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
