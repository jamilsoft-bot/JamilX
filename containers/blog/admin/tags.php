...
<div class="grid gap-6 lg:grid-cols-3">
    <div class="rounded-xl border border-slate-200 bg-white p-6">
        ...
        <form action="admin/blog?action=tags" method="post" class="mt-4 space-y-4">
                ...
                <?php foreach ($tags as $tag): ?>
                    <div class="flex items-center justify-between px-6 py-4">
                        ...
                        <div class="flex gap-3 text-sm">
                            <a href="admin/blog?action=tags&edit=<?php echo blog_html($tag['id']); ?>" class="text-indigo-600 hover:text-indigo-700">Edit</a>
                            <a href="admin/blog?action=tags&delete=<?php echo blog_html($tag['id']); ?>" class="text-rose-600 hover:text-rose-700">Delete</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
