                                   ...
                                   // $re = $db->Query($sql2);
                                    ...
                                    echo "<td class='px-4 py-3'>
                                        <div class='flex items-center gap-2'>
                                            ...
                                            <a href='dashboard?b=$code&action=catupdate&cid=$id' class='inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-semibold text-slate-600'><i class='fa fa-edit'></i></a>
                                            <a href='dashboard?b=$code&action=cats&del=$id' class='inline-flex items-center justify-center rounded-full border border-rose-200 bg-rose-50 px-3 py-1 text-xs font-semibold text-rose-600'><i class='fa fa-trash'></i></a>
                                        </div>
                                    </td>";
                                }
