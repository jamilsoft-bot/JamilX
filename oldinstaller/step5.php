            ...
            <div class=" w3-card  w3-margin">
                ...
                <div class="w3-container ">
                    ...
                    <div class="row">
                       ...
                       <select name="country" id="cid" class="w3-input w3-border">
                        ...
                        <select name="role" id="rl1" class="w3-input w3-border" >
                        ...
                        <div class="col-md-4 w3-margin-top">
                        <a href="#" class="w3-input w3-border w3-red w3-btn">Exit</a>
